...
%\usepackage[utf8]{inputenc} % Sonderzeichen schreiben koennen (hier nicht benutzt)
\usepackage[ngerman]{babel} % Deutsche Abbildungszeichen
\usepackage{graphicx}   % Graphiken einfuegen
\usepackage{fancyhdr}   % Fuer Kopf- und Fusszeile
\usepackage{geometry}   % Seitenraender definieren
...
\usepackage{microtype}  % Automatische Anpassung der Zeilenmasse, dass unschoene Umbrueche vermieden werden
\usepackage{mathtools}  % Fuer Text auf/unter Pfeilen
...
\pagestyle{fancy}
\fancyhf{}
\setlength{\headheight}{28.1pt} % Hoehe der Kopfzeile
\rhead{\includegraphics[height=24pt]{HAWLogo}}    % HAW Logo in Kopfzeile einfuegen
\lhead{Bussysteme und Sensorik}  % Beschreibung in Kopfzeile

\renewcommand{\footrulewidth}{0.4pt}    % Linie in Fusszeile einfügen
\rfoot{\thepage}    % Seitenzahlen einfuegen
\lfoot{Department Informations- und Elektrotechnik}   % Fusszeile linksbuendig
...
\vspace{1cm}
{\scshape\LARGE Entwicklung Wetterstation unter Verwendung von Bussystemen \par}
\vspace{0.5cm}
...
\setcounter{page}{1}    % Seitenzaehler sicherheitshalber zuruecksetzen

\noindent
Lorem ipsum was wei{\ss} ich...
