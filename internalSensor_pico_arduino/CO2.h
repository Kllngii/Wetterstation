...
*/
/* 
    Source: https://github.com/tobiasschuerg/MH-Z-CO2-Sensors

    This library has been copied and renamed due to problems 
    with the term MHZ. It seems like there are definitions with that
    title for frequencies. 
